                            ...
                            <li className="Navbar-cart__user">
                                ...
                                <ul className="Navbar-cart__link">
                                    {this.props.userReducer.user.email && this.props.userReducer.user.username
                                        ...
                                        :   
                                            <>
                                            <li className="Navbar-cart__login"><Link to={process.env.PUBLIC_URL + "/login"}><p className="Navbar-cart__span">Iniciar sesión</p></Link></li>
                                            <li className="Navbar-cart__register"><Link to={process.env.PUBLIC_URL + "/register"}><p className="Navbar-cart__span">Registrarse</p></Link></li>
                                            </>
                                    }
